  ...
  return (
    <div className="">
      ...
      <div className="flex ml-10 mt-8 pl-[53px] pt-9 rounded-3xl bg-[#1AA928]">
        ...
        <div className=" ">
          <Image className="absolute right-[417px] w-[804px]" src={whitewavy} />
        </div>
      ...
      <div className={nunito.className}>
        ...
        <div className="grid grid-cols-5 ">
          ...
          <div>
            ...
            <h3 className="ml-14 text-[#434C56] mt-2 font-bold">Great Gasby</h3>
          ...
          <div>
            ...
            <h3 className="ml-[73px] text-[#434C56] mt-2 font-bold">Sapiens</h3>
            <h4 className="mt-[2px] text-sm ml-12 text-[#8D96A8]">
              Yuval Noah Harari
            </h4>
          </div>
        ...
        <div className="grid grid-cols-3">
          <div className="flex mt-9 ml-[40px] rounded-2xl shadow-xl bg-white">
            ...
            <h2 className="mt-4 ml-5 font-bold text-2xl text-[#303030]">20</h2>
          ...
          <div className="flex mt-9 ml-[30px] rounded-2xl shadow-xl bg-white">
            ...
            <h2 className="mt-4 ml-5 font-bold text-2xl text-[#303030]">03</h2>
            <h2 className="mt-12 -ml-7 font-normal text-md text-[#8A97A4]">
              Reading books
            </h2>
          </div>
